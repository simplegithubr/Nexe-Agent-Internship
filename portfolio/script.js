...
// Console message
console.log('%c🤖 AI Agent Portfolio', 'font-size: 20px; font-weight: bold; color: #6366f1;');
console.log('%cBuilt with HTML, CSS, and JavaScript', 'font-size: 14px; color: #64748b;');
console.log('%cCheck out the projects on GitHub!', 'font-size: 14px; color: #10b981;');
